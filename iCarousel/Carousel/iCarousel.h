...
@property (nonatomic, weak) IBOutlet __nullable id<iCarouselDataSource> dataSource;
@property (nonatomic, weak) IBOutlet __nullable id<iCarouselDelegate> delegate;
